...
| 2026-09-12 | Power BI release contract | src/release_readiness.py + tests/test_release_readiness.py + powerbi/semantic_model.yaml + powerbi/measures.dax | implemented | final audit now validates Drive-only semantic metadata, 29 curated tables, six pages, single-direction relationships and required governed measures |
