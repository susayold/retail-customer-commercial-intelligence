...
- `04_qa_reports/qa_source_contract_audit.csv` with null, range, domain and source-grain checks;
- all 46 declared Power BI exports;
...
- repository contracts for the three root-cause cases, five executive decisions, limitations and UAT; the semantic model must validate as Drive-only with 44 curated tables, six pages, single-direction relationships, and all required governed measures present.
