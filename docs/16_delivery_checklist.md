...
| 35 | Reconcile SQL/DAX | Implemented method; pending result | docs/14_powerbi_uat.md + docs/17_release_readiness.md + src/reconcile.py + Makefile `reconcile`; Drive QA output |
