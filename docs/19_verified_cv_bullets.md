...
- Built a Drive-backed retail customer and commercial intelligence pipeline over 8 source files, validating 2.6M transaction lines and 36.8M promotion rows; implemented source contracts, profiling, Parquet, DuckDB marts, QA and a governed 46-export Power BI contract.
